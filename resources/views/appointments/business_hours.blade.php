            ...
            <form action="{{route('business_hours.update')}}" method="post">
                ...
                @foreach($businessHours as $businessHour)
                    ...
                    <div class="input-field col s1">
                        <input type="number" name="data[{{$businessHour->day}}][step]" value="{{$businessHour->step}}"
                               placeholder="Step">
                    </div>
                    ...
                    <div class="input-field col s3">
                        <p>
                            <label>
                                <input value="true" name="data[{{$businessHour->day}}][off]" class="filled-in"
                                       type="checkbox" @checked($businessHour->off) />
                                <span>OFF</span>
                            </label>
                        </p>
                    </div>
